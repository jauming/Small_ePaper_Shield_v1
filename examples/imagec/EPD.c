...
void EPD_Class_begin(EPD_size sz)
{
	...
	this->EPD_Pin_EPD_CS      = Pin_EPD_CS;
	this->EPD_Pin_PANEL_ON    = Pin_PANEL_ON;
	this->EPD_Pin_BORDER      = Pin_BORDER;
	this->EPD_Pin_DISCHARGE   = Pin_DISCHARGE;
	this->EPD_Pin_PWM         = Pin_PWM;
...
void EPD_Class_frame_data_repeat(PROGMEM const uint8_t *image, EPD_stage stage) 
{
